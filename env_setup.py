...
YOUTUBE_API_KEY="<your youtube api key>"#cant provide one for you cauze youtube restricts searches from one api key to 45-50 per day so you should get one yourself. Sorry.